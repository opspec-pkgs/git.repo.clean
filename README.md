[![build](https://github.com/opspec-pkgs/git.repo.clean/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/git.repo.clean/actions/workflows/build.yml)
