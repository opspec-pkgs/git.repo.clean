[![Build Status](https://github.com/opspec-pkgs/git.repo.clean/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/git.repo.clean/actions?query=workflow%3Abuild+branch%3Amain)
